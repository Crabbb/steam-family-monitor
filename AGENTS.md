...
## Keywords
Steam API, Next.js, App Router, SQLite, Prisma, Telegram Bot, Background Jobs, Cron, Web UI, Dashboard

## Annotation
Steam Monitor Web Service — A highly responsive Next.js web application designed to monitor Steam libraries for a specific group of friends, sending beautifully formatted Telegram notifications whenever a new game is acquired. Built with local deployment in mind on a Raspberry Pi, using SQLite and Prisma.
